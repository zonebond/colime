...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@ravens-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderID.ravens || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@ravens/ToolRegistry") {}
