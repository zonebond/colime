...
const DEFAULT_TIMEOUT = Flag.RAVENS_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS || 2 * 60 * 1000
    ...
    const run = Effect.fn("ShellTool.run")(function* (
      ...
      const code: number | null = yield* Effect.scoped(
        Effect.gen(function* () {
          ...
          // Heartbeat: push status update when output stalls for >10s
          yield* Effect.forkScoped(
            Effect.forever(
              Effect.gen(function* () {
