...
import { InstallationChannel, InstallationVersion } from "@ravens-ai/core/installation/version"
import { NpmConfig } from "@ravens-ai/core/npm-config"
...
export const USER_AGENT = `ravens/${InstallationChannel}/${InstallationVersion}/${Flag.RAVENS_CLIENT}`
...
export class Service extends Context.Service<Service, Interface>()("@ravens/Installation") {}
    ...
    Effect.gen(function* () {
      ...
      const result: Interface = {
        ...
        method: Effect.fn("Installation.method")(function* () {
          if (process.execPath.includes(path.join(".ravens", "bin"))) return "curl" as Method
