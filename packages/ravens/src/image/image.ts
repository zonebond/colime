...
export class Service extends Context.Service<Service, Interface>()("@ravens/Image") {}
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.promise(async () => {
        try {
          ...
          ;(globalThis as typeof globalThis & { __RAVENS_PHOTON_WASM_PATH?: string }).__RAVENS_PHOTON_WASM_PATH =
            photonWasm
