...
export class Service extends Context.Service<Service, Interface>()("@ravens/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.RAVENS_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        RAVENS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        RAVENS_WORKSPACE_ID: config.id,
        RAVENS_EXPERIMENTAL_WORKSPACES: "true",
