...
import { lazy } from "@ravens-ai/core/util/lazy"
...
import { NonNegativeInt, PositiveInt } from "@ravens-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@ravens/Pty") {}
