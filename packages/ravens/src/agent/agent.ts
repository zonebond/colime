...
export class Service extends Context.Service<Service, Interface>()("@ravens/Agent") {}
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          build: {
            name: "build",
            description: "The default agent with full tool access and permission-based execution",
            options: {},
          ...
          plan: {
            name: "plan",
            description: "Read-only planning mode — explore code and design solutions without editing files",
            options: {},
            permission: Permission.merge(
              defaults,
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".ravens", "plans", "*.md")]: "allow",
