...
import type { Event, GlobalEvent, OpencodeClient } from "@ravens-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@ravens/RunStreamTransport") {}
