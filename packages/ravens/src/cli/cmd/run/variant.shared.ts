...
//
// The saved variant persists across sessions in ~/.local/state/ravens/model.json
...
class Service extends Context.Service<Service, VariantService>()("@ravens/RunVariant") {}
