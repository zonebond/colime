import type * as SDK from "@ravens-ai/sdk/v2"
...
const disabled = process.env["RAVENS_DISABLE_SHARE"] === "true" || process.env["RAVENS_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@ravens/ShareNext") {}
