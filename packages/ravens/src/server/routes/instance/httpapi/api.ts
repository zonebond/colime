...
import { DocumentApi } from "./groups/document"
...
import { SearchApi } from "./groups/search"
...
export const RootHttpApi = HttpApi.make("ravens-root")
  .addHttpApi(ControlApi)
  .addHttpApi(GlobalApi)
  .middleware(SchemaErrorMiddleware)
  .middleware(Authorization)

export const InstanceHttpApi = HttpApi.make("ravens-instance")
  .addHttpApi(ConfigApi)
  .addHttpApi(DocumentApi)
...
export const RavensHttpApi = HttpApi.make("ravens")
