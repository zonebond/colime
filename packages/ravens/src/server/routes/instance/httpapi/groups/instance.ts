...
export const SkillUpdatePayload = Schema.Struct({
  description: Schema.optional(Schema.String),
      ...
      .add(
        HttpApiEndpoint.post("dispose", InstancePaths.dispose, {
          ...
          OpenApi.annotations({
            ...
            description: "Clean up and dispose the current ravens instance, releasing all resources.",
          }),
        ),
        HttpApiEndpoint.get("path", InstancePaths.path, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the ravens instance.",
          }),
        ),
        ...
        HttpApiEndpoint.get("command", InstancePaths.command, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all available commands in the ravens system.",
          }),
        ),
        HttpApiEndpoint.get("agent", InstancePaths.agent, {
          ...
          OpenApi.annotations({
            ...
            summary: "List agents",
            description: "Get a list of all available AI agents in the ravens system.",
          }),
        ),
        HttpApiEndpoint.get("skill", InstancePaths.skill, {
          ...
          OpenApi.annotations({
            ...
            summary: "List skills",
            description: "Get a list of all available skills in the ravens system.",
          }),
        ),
        HttpApiEndpoint.post("skillReload", InstancePaths.skillReload, {
          query: WorkspaceRoutingQuery,
          success: described(Schema.Boolean, "Skills reloaded"),
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "app.skills.reload",
            summary: "Reload skills",
            description: "Re-scan and reload all skills from disk. Use after adding or modifying skill files.",
          }),
        ),
        HttpApiEndpoint.post("skillRemove", InstancePaths.skillRemove, {
          query: Schema.Struct({
            ...WorkspaceRoutingQueryFields,
            name: Schema.String,
          }),
          ...
          OpenApi.annotations({
            ...
            description: "Delete a skill file from disk and reload the skill registry.",
          }),
        ),
        HttpApiEndpoint.post("skillCreate", InstancePaths.skill, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new SKILL.md file in the global skills directory and reload.",
          }),
        ),
        HttpApiEndpoint.put("skillUpdate", InstancePaths.skill, {
          query: Schema.Struct({
            ...WorkspaceRoutingQueryFields,
            name: Schema.String,
          }),
