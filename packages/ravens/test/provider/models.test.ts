...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.RAVENS_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.RAVENS_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.RAVENS_MODELS_PATH = undefined
  Flag.RAVENS_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.RAVENS_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.RAVENS_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
