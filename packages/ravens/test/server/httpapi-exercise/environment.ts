...
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "ravens")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "ravens")
...
Flag.RAVENS_DB = exerciseDatabasePath
